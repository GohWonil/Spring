...
public class Ex05Test{
  ...
  void test3(){
    QBoardData boardData = QBoardData.boardData;
    List<BoardData> items = (List<BoardData>)repository.findAll(boardData.subject.contains("목"), Sort.by(Sort.Order.desc("createdAt")));
  ...
  void test4(){
    ...
    Pageable pageable = PageRequest.of(1, 3, Sort.by(Sort.Order.desc("createdAt")));
